...
public class TelaServidorConectadoController {
    ...
    private void handleLogoClick(MouseEvent event) {
        ...
        String fxmlPath = "/fxml/tela_aguardando_pagamento.fxml";
        ...
        try {
            Parent telaAguardandoPagamento = new FXMLLoader(url).load();
            Scene sceneAguardandoPagamento = new Scene(telaAguardandoPagamento);

            Stage stage = (Stage) imgLogo.getScene().getWindow();
            stage.setScene(sceneAguardandoPagamento);
