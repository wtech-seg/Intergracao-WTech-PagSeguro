...
public class TelaAguardandoPagamentoController {
    ...
    private void handleLogoClick(MouseEvent event) {
        ...
        String fxmlPath = "/fxml/tela_pagamento_selecionado.fxml";
        ...
        try {
            Parent telaPagamentoSelecionado = new FXMLLoader(url).load();
            Scene scenePagamentoSelecionado = new Scene(telaPagamentoSelecionado);

            Stage stage = (Stage) imgLogo.getScene().getWindow();
            stage.setScene(scenePagamentoSelecionado);
